...
LRESULT COpenLiveDlg::OnJoinChannel(WPARAM wParam, LPARAM lParam)
{
	...
	lpAgoraObject->SetVideoProfile((VIDEO_PROFILE_TYPE)nVideoSolution, m_dlgSetup.IsWHSwap());
	lpAgoraObject->SetEncoderType(m_dlgSetup.GetEncoderType());
	lpAgoraObject->EnableIntraRequest(m_dlgSetup.GetCheckIntra());
