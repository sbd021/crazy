...
void CVideoDlg::AdjustSizeVideo6(int cx, int cy)
{
	...
	m_wndLocal.MoveWindow(0, m_rcVideoArea.top, m_rcVideoArea.Width() / 3, m_rcVideoArea.Height() / 2, FALSE);
	m_wndVideo[0].MoveWindow(m_rcVideoArea.Width() / 3, m_rcVideoArea.top, m_rcVideoArea.Width() / 3, m_rcVideoArea.Height() / 2, FALSE);
	m_wndVideo[1].MoveWindow(m_rcVideoArea.Width() * 2 / 3, m_rcVideoArea.top, m_rcVideoArea.Width() / 3, m_rcVideoArea.Height() / 2, FALSE);


	m_wndVideo[2].MoveWindow(0, m_rcVideoArea.top + m_rcVideoArea.Height() / 2, m_rcVideoArea.Width() / 3, m_rcVideoArea.Height() / 2, FALSE);
	m_wndVideo[3].MoveWindow(m_rcVideoArea.Width() / 3, m_rcVideoArea.top + m_rcVideoArea.Height() / 2, m_rcVideoArea.Width() / 3, m_rcVideoArea.Height() / 2, FALSE);
	m_wndVideo[4].MoveWindow(m_rcVideoArea.Width() * 2 / 3, m_rcVideoArea.top + m_rcVideoArea.Height() / 2, m_rcVideoArea.Width() / 3, m_rcVideoArea.Height() / 2, FALSE);
...
void CVideoDlg::AdjustSizeVideo8(int cx, int cy)
{
	int col = 4;
	int row = 2;
	m_wndLocal.MoveWindow(0, m_rcVideoArea.top, m_rcVideoArea.Width() / col, m_rcVideoArea.Height() / 2, FALSE);
	m_wndVideo[0].MoveWindow(m_rcVideoArea.Width() / 4, m_rcVideoArea.top, m_rcVideoArea.Width() / 4, m_rcVideoArea.Height() / 2, FALSE);
	m_wndVideo[1].MoveWindow(m_rcVideoArea.Width() / 2, m_rcVideoArea.top, m_rcVideoArea.Width() / 4, m_rcVideoArea.Height() / 2, FALSE);
	m_wndVideo[2].MoveWindow(m_rcVideoArea.Width() * 3 / 4, m_rcVideoArea.top, m_rcVideoArea.Width() / 4, m_rcVideoArea.Height() / 2, FALSE);
	
	m_wndVideo[3].MoveWindow(0, m_rcVideoArea.top + m_rcVideoArea.Height() / 2, m_rcVideoArea.Width() / 4, m_rcVideoArea.Height() / 2, FALSE);
	m_wndVideo[4].MoveWindow(m_rcVideoArea.Width() / 4, m_rcVideoArea.top, m_rcVideoArea.Width() / 4, m_rcVideoArea.Height() / 2, FALSE);
	m_wndVideo[5].MoveWindow(m_rcVideoArea.Width() / 2, m_rcVideoArea.top + m_rcVideoArea.Height() / 2, m_rcVideoArea.Width() / 4, m_rcVideoArea.Height() / 2, FALSE);
	m_wndVideo[6].MoveWindow(m_rcVideoArea.Width() * 3 / 4, m_rcVideoArea.top + m_rcVideoArea.Height() / 2, m_rcVideoArea.Width() / 4, m_rcVideoArea.Height() / 2, FALSE);
...
void CVideoDlg::ShowVideo8()
{
	...
	m_wndLocal.MoveWindow(0, m_rcVideoArea.top, m_rcVideoArea.Width() / 4, m_rcVideoArea.Height() / 2, FALSE);
	m_wndVideo[0].MoveWindow(m_rcVideoArea.Width() / 4, m_rcVideoArea.top, m_rcVideoArea.Width() / 4, m_rcVideoArea.Height() / 2, FALSE);
	m_wndVideo[1].MoveWindow(m_rcVideoArea.Width() / 2, m_rcVideoArea.top, m_rcVideoArea.Width() / 4, m_rcVideoArea.Height() / 2, FALSE);
	m_wndVideo[2].MoveWindow(m_rcVideoArea.Width() * 3 / 4, m_rcVideoArea.top, m_rcVideoArea.Width() / 4, m_rcVideoArea.Height() / 2, FALSE);

	m_wndVideo[3].MoveWindow(0, m_rcVideoArea.top + m_rcVideoArea.Height() / 2, m_rcVideoArea.Width() / 4, m_rcVideoArea.Height() / 2, FALSE);
	m_wndVideo[4].MoveWindow(m_rcVideoArea.Width() / 4, m_rcVideoArea.top + m_rcVideoArea.Height()/2, m_rcVideoArea.Width() / 4, m_rcVideoArea.Height() / 2, FALSE);
	m_wndVideo[5].MoveWindow(m_rcVideoArea.Width() / 2, m_rcVideoArea.top + m_rcVideoArea.Height() / 2, m_rcVideoArea.Width() / 4, m_rcVideoArea.Height() / 2, FALSE);
	m_wndVideo[6].MoveWindow(m_rcVideoArea.Width() * 3 / 4, m_rcVideoArea.top + m_rcVideoArea.Height() / 2, m_rcVideoArea.Width() / 4, m_rcVideoArea.Height() / 2, FALSE);
...
void CVideoDlg::RebindVideoWnd()
{
	...
	if (m_nScreenMode != SCREEN_VIDEOMULTI) {
		if (m_listWndInfo.GetCount() <= 1)
			...
			ShowVideo4();
		else if (m_listWndInfo.GetCount() >= 4 && m_listWndInfo.GetCount() < 6 ){
			ShowVideo6();
		}
		else if (m_listWndInfo.GetCount() >= 6 && m_listWndInfo.GetCount() <= 7)
		{
			ShowVideo8();
		}
	}
